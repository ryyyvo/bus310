...
export function ActivityPlanning() {
  ...
  const [newActivity, setNewActivity] = useState({
    name: '',
    type: 'hike' as 'hike' | 'activity',
    day: 'Day 1',
    duration: '',
    difficulty: 'moderate' as Activity['difficulty'],
    distance: '',
    elevation: '',
    description: '',
  });
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setNewActivity({ ...newActivity, type: e.target.value as 'hike' | 'activity' })
                    }
                  >
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setNewActivity({
                          ...newActivity,
                          difficulty: e.target.value as Activity['difficulty'],
                        })
                      }
                    >
