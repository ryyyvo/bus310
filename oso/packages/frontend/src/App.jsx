      ...
      <div className="min-h-screen bg-background">
        ...
        <header className="border-b" style={{ backgroundColor: "#fcf6e9" }}>
          <div className="container mx-auto px-4 py-3">
            <div className="flex items-center gap-6 bg-[#fcf6e9]">
              <img src={osoLogo} alt="oso Logo" className="h-20 mr-4" />
              <div className="flex-1">
                <TabsList className="grid w-full grid-cols-6 bg-transparent">
                  <TabsTrigger value="planner" className="flex items-center gap-2 data-[state=active]:bg-[#3d5a3d] data-[state=active]:text-white">
                    <Sparkles className="h-4 w-4" />
                    <span className="hidden sm:inline">AI Planner</span>
                    <span className="sm:hidden">AI</span>
                  </TabsTrigger>
                  <TabsTrigger value="booking" className="flex items-center gap-2 data-[state=active]:bg-[#3d5a3d] data-[state=active]:text-white">
                    <MapPin className="h-4 w-4" />
                    <span className="hidden sm:inline">Site Booking</span>
                    <span className="sm:hidden">Sites</span>
                  </TabsTrigger>
                  <TabsTrigger value="meals" className="flex items-center gap-2 data-[state=active]:bg-[#3d5a3d] data-[state=active]:text-white">
                  ...
                  <TabsTrigger value="account" className="flex items-center gap-2 data-[state=active]:bg-[#3d5a3d] data-[state=active]:text-white">
